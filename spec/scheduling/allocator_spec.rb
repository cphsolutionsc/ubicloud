...
RSpec.describe Al do
  ...
  describe "candidate_selection" do
    ...
    it "applies data center exclusion filter" do
      vmh1 = create_vm_host(data_center: "dc1", total_cpus: 14, total_cores: 7, used_cores: 4, total_hugepages_1g: 10, used_hugepages_1g: 2)
      ...
      req.data_center_exclusion_filter = ["dc1"]
      cand = Al::Allocation.candidate_hosts(req)
